...
export const Route = createFileRoute("/ko")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "다낭 베이커리, 다낭 케이크, 다낭 기념품, 베트남 케이크, 다낭 빵집, 다낭 선물, 오렌지 스폰지 케이크, 다낭 육포, Tiem Banh Thanh" },
      { property: "og:title", content: TITLE },
      { property: "og:description", content: DESC },
      { property: "og:type", content: "website" },
      { property: "og:url", content: `${SITE}/ko` },
      { property: "og:image", content: OG_IMAGE },
      { property: "og:image:alt", content: "다낭 오렌지 스폰지 케이크 선물 박스 – Tiệm Bánh Thanh" },
