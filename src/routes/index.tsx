...
const PRODUCTS: Product[] = [
  ...
  {
    id: "bo-kho-soi-cay",
    name: "Bò khô sợi sả ớt – cay",
    tagline: "Hũ 500g · Bò Khô Sạch",
    desc: "Sợi bò mềm dai, thấm vị sả ớt đậm đà, cay nồng đặc trưng. 100% bò tươi nguyên chất – không pha thịt heo, không phẩm màu, không chất bảo quản.",
    img: boKhoSoi.url,
    badge: "Hũ 500g",
    meta: ["100% bò tươi", "Vị cay đậm đà", "Hút chân không theo yêu cầu"],
  },
  {
    id: "bo-kho-soi-it-cay",
    name: "Bò khô sợi sả ớt – ít cay",
    tagline: "Hũ 500g · Bò Khô Sạch",
    desc: "Vẫn là sợi bò mềm dai thấm vị sả thơm, nhưng giảm cay – phù hợp cho trẻ em, người lớn tuổi và khách không ăn được cay nhiều.",
    img: boKhoSoiLat.url,
    badge: "Ít cay",
    meta: ["Giảm cay – dễ ăn", "Không phẩm màu", "Hút chân không theo yêu cầu"],
  },
  {
    id: "bo-kho-lat-cay",
    name: "Bò khô lát – cay",
    tagline: "Hũ 500g · Loại 1",
    desc: "Miếng bò dày dặn, ướp gia vị cay nồng, sấy khô tự nhiên. Phù hợp lai rai, làm quà biếu hoặc dùng kèm bia.",
    img: boKhoLat.url,
    badge: "Hũ 500g",
    meta: ["Thịt thăn bò chọn lọc", "Vị cay đậm đà", "Hút chân không theo yêu cầu"],
  },
];
