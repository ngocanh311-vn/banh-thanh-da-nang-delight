...
const DESC =
  "Soft, fluffy orange sponge cake, shrimp-and-pork bánh ít, and clean dried beef from Da Nang. Elegant gift packaging, on-demand delivery – K25/5 Ly Thuong Kiet, Hai Chau, Da Nang.";
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: DESC },
      {
        name: "keywords",
        content:
          "Da Nang bakery, orange sponge cake Da Nang, Vietnamese gift cake, Banh It Da Nang, dried beef Da Nang, Tiem Banh Thanh, Vietnam souvenir food",
      },
      ...
      { property: "og:image", content: OG_IMAGE },
      {
        ...
        content: "Orange sponge cake gift box – Tiệm Bánh Thanh, Da Nang",
      },
